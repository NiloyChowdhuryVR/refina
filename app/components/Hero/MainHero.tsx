    ...
    <div className="relative w-full max-w-220 h-full  border border-gray-400">
          ...
          <div className="flex flex-col gap-5 pl-[5%] pt-[5%] h-full">
            ...
            <div className='flex gap-5'>
              <button className='bg-black text-white px-5 py-1 hover:bg-transparent border-black border-2 hover:text-black cursor-pointer text-sm font-semibold font-roboto'>Get Started</button>
              <button className='border-black border-2 hover:bg-black hover:text-white text-black px-5 py-1 cursor-pointer text-sm font-semibold font-roboto'>Watch Tutorial</button>
            </div>
          </div>
        </div>
  )
